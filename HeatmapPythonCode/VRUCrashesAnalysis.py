...
import numpy as np
import pandas as pd # Import pandas to read CSVs initially
...
accidents_df = pd.read_csv("VRUCrashes250ftBusStopNICCNM.csv")
# Assuming 'LONGITUDE' and 'LATITUDE' columns in VRUCrashes1400ftBusStopNICCNM.csv represent coordinates
# And assuming these coordinates are in WGS84 (EPSG:4326)
...
m.save("accident_heatmap_pedcrashes.html") #Update these names
print("Map saved as accident_heatmap_pedcrashes.html. Open it in a web browser to view.") #Update these names
